    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto space-y-6 sm:px-6 lg:px-8">
            ...
            <div class="rounded-lg bg-white p-6 shadow-sm">
                ...
                @endif
                <form method="post" action="{{ route('admin.campaigns.ads.bulk') }}">
                    @csrf
                    <div class="mb-3 flex flex-wrap items-center justify-between gap-3">
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <button class="rounded-md bg-slate-700 px-4 py-2 text-sm text-white" type="submit" onclick="return confirm('Apply this bulk action to the selected campaigns?');">Run</button>
                        </div>
