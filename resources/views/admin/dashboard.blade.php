        ...
        <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                @if (Auth::user()->hasRole('admin', 'editor'))
                    ...
                    <a href="{{ route('admin.editorial-dossiers.index') }}" class="rounded-md bg-amber-600 px-4 py-2 text-sm text-white">Evidence Dossiers</a>
                @endif
                @if (Auth::user()->hasRole('admin', 'editor', 'support', 'dev', 'developer'))
                    <a href="{{ route('admin.ai-operator.index') }}" class="rounded-md bg-indigo-700 px-4 py-2 text-sm text-white">Operator Assistant</a>
                @endif
